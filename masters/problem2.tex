...
\begin{align*}
    ...
    & \times (e ^{i \overrightarrow{p ^{\prime}} \cdot \overrightarrow{x}} b^{s \prime} _{\overrightarrow{p^{\prime}}}(\gamma \cdot p ^{\prime} + m)u^{s \prime}(\overrightarrow{p ^{\prime}})  + e ^{ - i \overrightarrow{p ^{\prime}} \cdot \overrightarrow{x}}c^{s ^{\prime} \dagger} _{\overrightarrow{p ^{\prime}}}(\gamma \cdot p ^{\prime} -  m)v^{s^{\prime}}(\overrightarrow{p ^{\prime}}))
\end{align*}
