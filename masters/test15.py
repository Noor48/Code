...
plt.ylim(0,1.01)
plt.vlines(1,0,1,ls='--')
plt.xticks([1,5], [r'$l_{x}$',r'$E/ l_{p}$'],fontsize='20')
plt.vlines(5,0,0.2,ls='--')
plt.hlines(0.2,0,5,ls='--')
plt.hlines(1,0,1,ls='--')
plt.yticks([0.2,1], [r'$l_{p}$',r'$E/ l_{x}$'],fontsize='20')
plt.xlabel('x',fontsize=20)
plt.ylabel('p',fontsize=20)
plt.fill_between(b,c,0.2, color="skyblue",hatch='/', alpha=0.5)
#plt.fill_between([0,1],[0,0],[1,1], color="skyblue",hatch='/', alpha=0.5)
plt.text(2, 0.6, 'xp = E', fontsize=20)
plt.text(0.4, 0.11, 'h', fontsize=20)
#ax.set_xticks([])
#ax.set_yticks([])
#ax.
plt.show()
