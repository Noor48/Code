...
\begin{document}
    ...
    zeta funtion becomes zero $\zeta(\frac{1}{2}-it) = 0$. Hilbert-P$\acute{o}$lya conjecture suggests that the imaginary parts of the nontrivial zeros are the eigenvalues 
    ...
    of the Hilbert-P$\acute{o}$lya  conjecture should take the form\cite{s1} 
