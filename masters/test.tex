...
%\usepackage[a4paper,width=150mm,top=25mm,bottom=25mm,blindingoffset=6mm]{geometry}
\usepackage{fancyhdr}
\pagestyle{fancy}
%\fancyhead{}
...
\title{\Huge{Out-of-Time-Order Correlator of Berry-Keating model}}
\author{}
\hypersetup{
    colorlinks=true,
    linkcolor=black,
...
\begin{document}
    ...
    %    \fontsize{19}{0}\bf {Out-of-Time-Order-Correlator of $H=xp$ }}
    %    \end{center}
    %    \large
    %    \large
    %    \large
    ...
    %    \begin{center}\includegraphics[scale=0.5]{logo.jpg}\end{center}
    ...
    \begin{center}
        ...
        \thispagestyle{empty}
        \begin{center}\setstretch{1.7}{
        \fontsize{19}{0}\bf {Out-of-Time-Order Correlator of Berry-Keating model }}
        \end{center}
        ...
        \large\begin{center}\textit{by}\end{center}
        \large\begin{center}\bf Roll: 106712 \end{center}
        \large\begin{center}\bf{Registration: 2016-514-722}\end{center}
        \vspace*{1\baselineskip}
        \begin{center}\includegraphics[scale=0.5]{logo.jpg}\end{center}
        \large\begin{center}\bf{University of Dhaka}\end{center}
...
\renewcommand\contentsname{Table of Contents}
    ...
    This result led to the missing spectral interpretation of the Riemann zeros, according to which there is a continuum of eigenstates (represented by the term $\frac{E}{\pi}
    ...
    \section{The Hamitoninan $H_{0} = xp$}
        ...
        Berry-Keating defined the quantum Hamiltonian $H_{0}$ as the normal ordered expression 
        ...
        \end{equation}
        Hence the spectrum of $H_{0}$ is discrete, with a level spacing decreasing for larger values of $N$. The normalization constant of the wave function is now 
    ...
    \chapter{Out-of-Time-Order Correlator of Berry-Keating}
        ...
        \lstinputlisting[language=C++, caption=matrix.h]{matrix.h}
        \lstinputlisting[language=C++, caption=box.h]{box.h}
        \lstinputlisting[language=C++, caption=hamiltonian.h]{hamiltonian.h}
        \lstinputlisting[language=C++, caption=force.h]{force.h}
        \lstinputlisting[language=C++, caption=molecular.h]{molecular.h}
        \lstinputlisting[language=C++, caption=main.cpp]{main2.cpp}
        \lstinputlisting[language=Python, caption=plot.py]{plot.py}
        \newpage
