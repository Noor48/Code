...
\begin{document}
    ...
    \section{Out-of-Time-Order Correlator of $H=xp$}
        ...
        In the definition of OTOC, we consider the thermal average of $- \left\langle\left[W(t),V(0)\right]^{2}\right\rangle$. The thermal average is especially important
