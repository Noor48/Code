...
\begin{document}
    ...
    \section{Out-of-Time-Order Correlator of $H=xp$}
        ...
        \begin{equation}
            c_{n} \equiv \left\langle \middle|\left[x(t),p(0)\right]^{2}\middle|\right\rangle
        \end{equation}
        ...
        thermal OTOC. Once we compute microcanonical OTOCs, we can obtain the thermal OTOC bu taking their thermal average 
