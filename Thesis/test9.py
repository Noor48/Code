...
datas=np.loadtxt("IMAG_OPTICAL_CONDUCTIVITY_2D.dat",dtype=np.float64,skiprows=1) 
...
plt.legend()
plt.title("Imaginary Optical Conductivity", fontsize=20)
